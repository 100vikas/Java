...
public class ArrayListEx1 {
	public static void main(String[] args) {
		...
		arr.remove(2);                          // remove element index wise;
		System.out.println(arr);
...
//		cars.removeAll(cars); // remove all record in the list
		System.out.println(cars);
		System.out.println(cars.subList(1,3));      //	Return a sublist which provides access to a range of this list's items
        
		
		  //toArray
		   Object[] carsArray=cars.toArray();
		       for(Object item : carsArray) {        //The toArray() method returns an array containing all of the items in the list.
